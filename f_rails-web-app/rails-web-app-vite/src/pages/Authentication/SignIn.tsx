          ...
          <div className="h-full w-1/2 flex flex-col items-center justify-center">
            <div className="flex gap-x-2 justify-center items-center">
              <img
                ...
                className="h-10 w-10"
              />
              <div className="text-xl font-bold">Quick Admin</div>
            </div>
            <div className="text-gray-400 w-72 mt-4 text-center">
              Unlock the full potential of your quick commerce strategy with our
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="flex flex-col w-[60dvh] justify-center items-center">
                ...
                <div className="flex flex-col w-full justify-center items-center mt-5">
                  ...
                  <input
                    type="submit"
                    className="py-4 w-full mt-4 text-white rounded-lg flex items-center justify-center cursor-pointer bg-[#3c50e0]"
                  />
                </div>
              </div>
              <div className="mt-6 text-center">
                <span>
                  ...
                  <span className="text-[#3c50e0] cursor-pointer">Sign Up</span>
                </span>
              </div>
            </form>
          </div>
